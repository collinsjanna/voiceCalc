...
namespace VoiceCalc
{
    class MathematicalExpressionEvaluator
    {
        ...
        {
            return (op != "+" && op != "-" && op != "*" && op != "/" && op != "(" && op != ")"); //ändrat
        }
        ...
        private static double EvaluatePostfix(List<string> expression)
        {
            ...
            return double.Parse(evalStack.Peek()); //problem med /
        }
        ...
        //returns varje operator och operand som en lista av objekt
