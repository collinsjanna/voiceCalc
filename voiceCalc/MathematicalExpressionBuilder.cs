...
using System.Speech.Recognition; //voice  
using System.Speech.Synthesis; //voice
    ...
    class MathematicalExpressionBuilder
     {
        ...
        System.Globalization.CultureInfo myCulture = null; // försök till svenska
        SpeechRecognitionEngine recEngine = null; //record
        SpeechSynthesizer speechSynth = null; //speech
        ...
        {
            calculator = myCalc;
            myCulture = new System.Globalization.CultureInfo("en-US"); //engelska ej svenska
            recEngine = new SpeechRecognitionEngine(myCulture);
            speechSynth = new SpeechSynthesizer(); //argument?
            speechSynth.SelectVoiceByHints(VoiceGender.Female); //kvinnlig röst
            InitializeNumberTable();        //varför i konstruktorn?
        ...
        private void prepareSpeachRecognition()
        {
            ...
            //recEngine.RecognizeAsync(RecognizeMode.Multiple); //flyttat ner
        ...
        void recEngine_SpeechRecognized(object sender, SpeechRecognizedEventArgs e)
        {
            ...
            switch (e.Result.Text)
            {
                ...
                case "times":
                    ...
                    break;
                case "divided by":
                    UpdateExpressionCharacteristics("/"); //ändrat
                    break;
                case "open bracket":
                    UpdateExpressionCharacteristics("(");
                    break;
        ...
        public void StartSpeechRecognition()
        {
            ...
            speechSynth.Speak("Hello I´m Calculator, how can i help you?"); //hälsar
        }
